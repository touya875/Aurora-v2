            ...
            <div className="px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
                <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
                    <div className="sm:col-span-2">
                        <a href="/" aria-label="Go home" title="Company" className="inline-flex items-center">
                            ...
                            <span className="ml-2 text-xl font-bold tracking-wide text-gray-800 uppercase">Aurora</span>
                        </a>
                        <div className="mt-6 lg:max-w-sm">
                            <p className="text-sm text-gray-800">
                                Chào mừng đến với cửa hàng AURORA. Chúng tôi sẽ mang lại cho bạn những sản phẩm tốt và hợp với xu hướng nhất.
                            </p>
                    ...
                    <div className="space-y-2 text-sm">
                        ...
                        <div className="flex">
                            ...
                            <a href="tel:850-123-5021" aria-label="Our phone" title="Our phone" className="transition-colors duration-300 text-deep-purple-accent-400 hover:text-deep-purple-800">123-456-7890</a>
                        </div>
                        <div className="flex">
                            <p className="mr-1 text-gray-800">Email:</p>
                            <a href="mailto:info@lorem.mail" aria-label="Our email" title="Our email" className="transition-colors duration-300 text-deep-purple-accent-400 hover:text-deep-purple-800">abc@gmail.mail</a>
                        </div>
                        <div className="flex">
                            ...
                            <a href="https://www.google.com/maps" target="_blank" rel="noopener noreferrer" aria-label="Our address" title="Our address" className="transition-colors duration-300 text-deep-purple-accent-400 hover:text-deep-purple-800">
                                123 An Dương Vương, TP.HCM
                            </a>
                        </div>
                    </div>
                    <div>
                        <span className="text-base font-bold tracking-wide text-gray-900">Mạng xã hội của chúng tôi</span>
                        <div className="flex items-center mt-1 space-x-3">
                            <a href="https://x.com/?lang=vi" className="text-gray-500 transition-colors duration-300 hover:text-deep-purple-accent-400">
                ...
                <div className="flex flex-col-reverse justify-between pt-5 pb-10 border-t lg:flex-row">
                    <p className="text-sm text-gray-600">
                        © Bản quyền năm 2024. Thuộc về cửa hàng AURORA
                    </p>
                    <ul className="flex flex-col mb-3 space-y-2 lg:mb-0 sm:space-y-0 sm:space-x-5 sm:flex-row">
                        ...
                        <li>
                            <a className="text-sm text-gray-600 transition-colors duration-300 hover:text-deep-purple-accent-400">Quyền &amp; Điều khoản</a>
                        </li>
                    </ul>
                </div>
            </div>
